...
namespace Drupal\gql_api_portfolio\Plugin\GraphQL\SchemaExtension;

use Drupal\graphql\GraphQL\ResolverBuilder;
use Drupal\graphql\GraphQL\ResolverRegistryInterface;
use Drupal\graphql\GraphQL\Response\ResponseInterface;
use Drupal\graphql\Plugin\GraphQL\SchemaExtension\SdlSchemaExtensionPluginBase;
use Drupal\gql_api_portfolio\GraphQL\Response\ProjectResponse;
use Drupal\gql_api_portfolio\Wrappers\QueryConnection;

/**
 * @SchemaExtension(
 *   id = "composable_extension_portfolio",
 *   name = "Composable Portfolio extension",
 *   description = "A simple extension that adds node related fields for the portfolio.",
 *   schema = "composable"
 * )
 */
class PortfolioSchemaExtension extends SdlSchemaExtensionPluginBase {
